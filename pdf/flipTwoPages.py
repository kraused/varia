...
#
# flipTwoPages.py: Flip two pages in a pdf file
#                  Usage: python2 flipTwoPages.py <pdf file> <page number> <page number>
...
def main(argv):
	...
	fileList = [tmpdir + "/%d.pdf" % x for x in range(1, n+1)]
